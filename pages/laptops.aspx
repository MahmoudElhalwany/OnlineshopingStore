<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="laptops.aspx.cs" Inherits="onlineShop.pages.laptops" %>
...
<body>
                ...
                <!--Account Data -->
                 ...
                 <div class="btn-group float-right b" id="account" runat="server">
                    ...
                    <button type="button" class="btn btn-dark dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                       ...
                       <a runat="server" href="user.aspx">Account Settings</a>
                           <br />
                ...
                <div class="btn-group float-right b" id="login" runat="server">
                    ...
                    <div class="dropdown-menu dropdown-menu-right f1">
                        <div class="px-4 py-3 ">
                            ...
                            <button type="submit" class="btn btn-primary" id="signinButton" runat="server" onserverclick="login_ServerClick"  >Sign in</button>
                        </div>
    ...
    <button class="btn btn-success bt" type="submit" id="findPro" runat="server" onserverclick="findPro_ServerClick">Search</button>
          </div>
  </div>
